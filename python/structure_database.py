...
def cleanup_parsed_cifs(cif_dict):
    ...
    for cif in cif_dict:
        ...
        cif["_symmetry_space_group_name_H-M"] = (
            cif["_symmetry_space_group_name_H-M"].replace(" ", "").replace("'", "")
        )
        if (
            cif["_space_group_name_H-M_alt"] != ""
            and cif["_symmetry_space_group_name_H-M"] == ""
        ):
            cif["_symmetry_space_group_name_H-M"] = (
                cif["_space_group_name_H-M_alt"].replace(" ", "").replace("'", "")
            )
        ...
        if cif["_symmetry_cell_setting"].strip() in ["?", "", " "] or cif[
            ...
            cif["_symmetry_space_group_name_H-M"] = str(
                this_entry.crystal.spacegroup_symbol
            )
